...
The file holds exactly what the model is given: the seven inputs in the order
...
to the model as a feature by accident.
...
FEATURES = ["LL", "PL", "PI", "fines_pct", "sand_pct", "log_energy", "Gs"]
